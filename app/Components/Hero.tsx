...
<div className="">
    <h1 className="text-4xl font-bold tracking-tight"> <span className="text-purple-500">Powering Seamless Transactions</span> <br /> <span className='text-black'>Across Port Harcourt and Nigeria.</span> </h1>
